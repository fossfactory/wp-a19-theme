      ...
      <div class="row">
         <div class="col-md-9 text-news">
            ...
            <div style="float:right; margin-top:2px; margin-bottom:1px;">
               <a><i class="fa fa-1x fa-fw fa-lg fa-whatsapp text-danger"></i></a>
               <a><i class="fa fa-1x fa-fw fa-lg fa-twitter text-danger"></i></a>
               <a><i class="fa fa-1x fa-facebook fa-fw fa-lg text-danger"></i></a>
               <a><i class="fa fa-1x fa-fw fa-google-plus-square fa-lg hub text-danger"></i></a>
            </div>
            <div style:"float:left; margin-top:9px; margin-bottom:2px;"><b>LINK:</b> <a class="barra-ferramentas_input"> http://artigo19.org/YHgFBML  </a>
         </div>
         <hr>
